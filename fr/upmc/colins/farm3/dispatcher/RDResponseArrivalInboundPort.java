...
/**
 * The class <code>RDResponseArrivalInboundPort</code> implements the inbound port
 ...
 */
public class			RDResponseArrivalInboundPort
...
implements	ResponseArrivalI
{
	 ...
	 * @throws Exception
	 */
	public				RDResponseArrivalInboundPort(
		String uri,
		ComponentI owner
		) throws Exception
	{
	...
	public void acceptResponse(Response resp) throws Exception {
		final RequestDispatcher sp = (RequestDispatcher) this.owner ;
