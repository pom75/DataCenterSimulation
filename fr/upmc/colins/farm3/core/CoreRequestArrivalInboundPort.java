...
/**
 * The class <code>CoreRequestArrivalInboundPort</code> implements the inbound port
 ...
 */
public class			CoreRequestArrivalInboundPort
...
implements	RequestArrivalI
{
	 ...
	 * @throws Exception
	 */
	public				CoreRequestArrivalInboundPort(
		String uri,
		ComponentI owner
		) throws Exception
	{
	...
	public void connectResponseConnection(String vmResponseArrivalInboundPortUri) throws Exception {
		final Core sp = (Core) this.owner ;
		final String furi = vmResponseArrivalInboundPortUri ;
		sp.handleRequestAsync(
				new ComponentService<Void>() {
					@Override
					public Void call() throws Exception {
